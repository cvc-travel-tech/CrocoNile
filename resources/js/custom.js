...
$("#nrGames").change(function () {
    ...
    while (nr < value) {
        elem.append($('<select class="browser-default" name="type[]"> <option value="" disabled selected>Room Type</option><option value="Single">Single</option><option value="double">Double</option><option value="Triple">Triple</option> </select>', { name: "Team1Player" + nr }));
        nr++;
    }
});
