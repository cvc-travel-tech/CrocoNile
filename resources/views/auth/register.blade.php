...
<div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <input placeholder="Comapny URL" id="url" type="text" class="form-control" name="url" required>
...
<div class="col-md-6">
                        ...
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                ...
                                <input placeholder="Password must be at least 8 characters" id="password" type="password" class="form-control" name="password" required>
...
<div class="col-md-6">
                        ...
                        <div class="form-group">
                                <button type="submit" class="btn btn-primary" style="background-color:    background: #5191fa;
; margin-left: 255px; width:200px; margin-top:20px">
                                    Register
                                </button>
                        </div>
