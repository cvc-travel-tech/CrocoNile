...
@media (max-width: 768px) { .form-wrap form .input {
   width:250px;
...
@media (min-width: 992px) {  .form-wrap form .input {
               
            } }


@media (min-width: 1200px) {  .form-wrap form .input {
    ...
    <h1 style="font-size: 2.5rem;text-align:center;"> Login </h1>
			...
			<div id="login-tab-content">
                ...
                @csrf
                    ...
                    <div class="col-md-6">
                        <input type="submit" class="button login" value="Login" style="background:#5191fa;">
