                            ...
                            <!--<a href="{{ url('/setting') }}" class="media-left"><img src="{{setting('admin', 'logo' , 'img')}}" class="img-circle img-sm" alt=""></a>-->
								<div class="media-body">
									...
									<div class="text-size-mini text-muted">
										<i class="icon-pin text-size-small"></i> &nbsp;Egypt
									</div>
								</div>
						...
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="{{route('admin.home')}}"><i class="icon-home4"></i> <span>Home</span></a></li>
																<li><a href="{{route('admin.company')}}"><i class="icon-home4"></i> <span>companies</span></a></li>
...
"></i> <span>Hotel</span></a>
								...
								<li>
								<a href="#"><i class="glyphicon glyphicon-tags"></i> <span>Travel For free</span></a>
								<ul>
										<li class="{{ active('Blog') }}" ><a href="{{route('admin.textarea')}}"><i class="icon-stack"></i> All</a></li>
                                        <li  class="{{ active('Blog' , 'create') }}"><a href="{{route('admin.Blog.create')}}"><i class="icon-stack"></i> Create</a></li>
									</ul>
								</li>
								...
								<li>
									...
									<a href="{{route('admin.booking.index')}}"><i class="glyphicon glyphicon-book"></i> <span>Today's Activity</span></a>
									<!--<ul>-->
