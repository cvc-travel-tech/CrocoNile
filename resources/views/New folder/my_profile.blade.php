        ...
        <div class="tabbable">
            <ul class="nav nav-tabs ht-nav-tabs">
                    ...
                    <a href="user/booking-history">All Booking</a>
                        ...
                        <!--                                    <li class="">-->
                        <!--    <a href="user/booking-history?status=completed">Completed</a>-->
                        <!--</li>-->
                        <!--                    <li class="">-->
                        <!--    <a href="user/booking-history?status=processing">Processing</a>-->
                        <!--</li>-->
                        <!--                    <li class="">-->
                        <!--    <a href="user/booking-history?status=confirmed">Confirmed</a>-->
                        <!--</li>-->
                        <!--                    <li class="">-->
                        <!--    <a href="user/booking-history?status=cancelled">Cancelled</a>-->
                        <!--</li>-->
                        <!--                    <li class="">-->
                        <!--    <a href="user/booking-history?status=paid">Paid</a>-->
                        <!--</li>-->
                            <!--                <li class="">-->
                            <!--<a href="user/booking-history?status=unpaid">Unpaid</a>-->
                        </li>
                                                </ul>
                            <!--No Booking History-->
                    </div>
                    <h6 style="margin-top: 50px;">All Booking History </h6>
                    <table class="table table-striped table-bordered" style="margin-top: 29px;">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Tour Guide Gender</th>
                                <th scope="col">Tour Guide Language</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th scope="row">
                                    <a href="{{  url('history_d/'. $book->id)  }}">{{ $book->id  }}</a>
                                </th>
                                <td>{{$book->res_at}}</td>
