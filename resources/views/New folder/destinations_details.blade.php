...
<h5 style="margin-left:16px;">{{ $value['tital'] }} </h5>
                    ...
                    <div class="col-lg-9 col-md-12">
                        <div class="bravo-list-item">
                            <div class="topbar-search">
                                <div class="text" >
                                   <h6 style="margin-bottom:30px">  Hotels & Cruises For This destinations </h6>
                                </div>
                                <div class="control">
                     ...
                     @foreach($hotels as $value)
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="item-tour  style="height:310px !important">
                                            <div class="thumb-image ">
                                                <a target="_blank" href="{{ url('hotel_ditails/'.$value['id']) }}">

                                                    <img class='img-responsive lazy' data-src="{{ asset('storage/tmp/uploads/'.\App\Images::find($value['images'][0])->file_path) }}   " style="height:167px" alt=''>
                                                </a>
                                            </div>
                                            <div class="location">
                                                <i class="icofont-paper-plane"></i> {{ $value->destination->name }}
                                            </div>
