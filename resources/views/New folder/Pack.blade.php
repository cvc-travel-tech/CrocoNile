...
@section('content')<!DOCTYPE html>
    ...
    <title>Discover The Best Egypt Tour - Tareek Al-Ofuk</title>
...
<body class="">
    ...
    @include('Frontend.nav')
        ...
        <div class="bravo_search_tour">
            <div class="bravo_banner" style="background-image: url({{ asset('frontend/images/egypt.jpg')}});padding:200px 0 ;">
                <div class="container">
                    <h1>
            ...
            <div class="container">
                <div class="content-tour">
                    <h1 style="text-align: center;">The Best Egypt Tour</h1>
                </div>
                <div class="row">
                                ...
                                @foreach($Package as $pac)
                                    ...
                                    <div class="col-lg-4 col-md-6">
                                        <div class="item-tour" style="height:390px">
                                            ...
                                            <div class="info">
                                                <div class="duration" style="width:45%">
