                                        ...
                                        <a href="{{ url('destinations_details/'.$destinations[0]->id) }}">
                                            <div class="image"
                                                ...
                                                <div class="content">
                                                    ...
                                                    <div class="desc"
                                                         style="background: #5191fa;">{{ $destinations[0]->hotels_count }}
                                                        Hotels 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <a href="{{ url('destinations_details/'.$value->id) }}">
                                                <div class="image"
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="desc"
                                                             style="background: #5191fa;">{{ $value->hotels_count }}
                                                            Hotels
                                                        </div>
                                                    </div>
                                                </div>
...
@foreach($Package as $pac)
                            ...
                            <div class="item-tour packages">
                                ...
                                <div class="info">
                                    <div class="duration">
                                        <i class="icofont-wall-clock" style="margin-right:5px"></i> {{$pac['duration']}}
                                    </div>
                                    <div class="g-price">
                                        <div class="prefix">
...
<center>
<h3>you must login to see our Packages</h3>
                            ...
                            @foreach($hotels as $value)
                                <div class="item-tour ">
                                    <div class="thumb-image ">
                                      ...
                                      <a href="{{ url('hotel_ditails/'.$value['id']) }}">   <img src="{{ asset('storage/tmp/uploads/'.\App\Images::find($value['images'][1])->file_path) }}"> </a>
                                
                                    </div>
                                    <div class="location">
                                        <i class="icofont-paper-plane">
                                            <p>{{$value->destination->name}}</p>
                                        </i>
