...
$("#nrGames").change(function () {
    ...
    while (nr < value) {
        elem.append($('<select class="browser-default"  name="room_type[]"> <option value="" disabled selected>Room Type</option><option value="Solo">Solo (Traveler)</option> <option value="Single">Single</option><option value="double">Double</option><option value="double_chd">Double +CHD</option><option value="twin">Twin</option><option value="twin_chd">Twin + CHD</option><option value="Triple">Triple</option> </select><select class="browser-default" name="no_of_adult[]" > <option value="" disabled selected>No of Adult</option><option value="1">1</option><option value="2">2</option><option value="3">3</option> </select> <select class="browser-default"  > <option value="" disabled selected>smoking</option><option value="1">Smoking</option><option value="2">non-smoking</option> </select>', { name: "Team1Player" + nr }));
        nr++;
    }
});
